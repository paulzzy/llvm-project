...
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
; GFX10-NEXT:    s_or_b32 s6, s6, vcc_lo
...
; GFX12-NEXT:    s_and_b32 s0, s3, exec_lo
...
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-NEXT:    s_or_b32 s2, s2, vcc_lo
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_b32 s0, s3, exec_lo
...
; GFX12-TRUE16-NEXT:    s_and_b32 s0, s2, exec_lo
...
; GFX12-TRUE16-NEXT:    s_mov_b32 s2, 0
; GFX12-TRUE16-NEXT:    s_mov_b32 s3, exec_lo
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
...
; GFX12-TRUE16-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-TRUE16-NEXT:    s_or_b32 s2, s2, vcc_lo
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_xor_b32 s0, exec_lo, s2
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_and_b32 s0, s0, exec_lo
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_or_b32 s1, s1, s0
...
; GFX12-FAKE16-NEXT:    s_and_b32 s0, s3, exec_lo
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s2, 0
...
; GFX12-FAKE16-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-FAKE16-NEXT:    s_or_b32 s2, s2, vcc_lo
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_xor_b32 s0, exec_lo, s2
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX11-TRUE16-NEXT:    buffer_gl1_inv
; GFX11-TRUE16-NEXT:    buffer_gl0_inv
; GFX11-TRUE16-NEXT:    s_or_b32 s2, s2, vcc_lo
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_xor_b32 s0, exec_lo, s2
; GFX11-TRUE16-NEXT:    s_and_b32 s0, s0, exec_lo
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_or_b32 s1, s1, s0
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_and_b32 s0, s3, exec_lo
...
; GFX11-FAKE16-NEXT:    buffer_gl1_inv
; GFX11-FAKE16-NEXT:    buffer_gl0_inv
; GFX11-FAKE16-NEXT:    s_or_b32 s2, s2, vcc_lo
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_xor_b32 s0, exec_lo, s2
...
; GFX12-FAKE16-NEXT:    s_and_b32 s0, s2, exec_lo
