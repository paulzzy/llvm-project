...
; GCN-IR-NEXT:    v_sub_i32_e32 v4, vcc, v8, v9
...
; GCN-IR-NEXT:    v_add_i32_e32 v12, vcc, v0, v9
...
; GCN-IR-NEXT:  .LBB1_8:
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, v1, 0, s[6:7]
...
; GCN-IR-NEXT:    v_min_u32_e32 v5, v2, v3
; GCN-IR-NEXT:    v_add_i32_e32 v3, vcc, 0xffffffd0, v5
; GCN-IR-NEXT:    v_addc_u32_e64 v4, s[6:7], 0, -1, vcc
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[0:1]
; GCN-IR-NEXT:    v_cmp_lt_u64_e32 vcc, 63, v[3:4]
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[6:7], 63, v[3:4]
...
; GCN-IR-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execnz .LBB9_8
; GCN-IR-NEXT:  .LBB9_1:
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; GCN-IR-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GCN-IR-NEXT:    s_mov_b64 exec, s[4:5]
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execz .LBB9_7
; GCN-IR-NEXT:  .LBB9_2: ; %udiv-bb1
...
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execnz .LBB9_9
; GCN-IR-NEXT:  .LBB9_3:
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-IR-NEXT:    s_xor_b64 s[4:5], exec, s[12:13]
; GCN-IR-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; GCN-IR-NEXT:    s_branch .LBB9_1
; GCN-IR-NEXT:  .LBB9_9:
; GCN-IR-NEXT:    v_mov_b32_e32 v4, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v5, 0
; GCN-IR-NEXT:    s_branch .LBB9_3
...
; GCN-IR-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execnz .LBB10_8
; GCN-IR-NEXT:  .LBB10_1:
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
; GCN-IR-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GCN-IR-NEXT:    s_mov_b64 exec, s[4:5]
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execz .LBB10_7
; GCN-IR-NEXT:  .LBB10_2: ; %udiv-bb1
...
; GCN-IR-NEXT:    s_mov_b64 exec, s[12:13]
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execnz .LBB10_9
; GCN-IR-NEXT:  .LBB10_3:
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-IR-NEXT:    s_xor_b64 s[4:5], exec, s[10:11]
; GCN-IR-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; GCN-IR-NEXT:  .LBB10_4: ; %udiv-preheader
; GCN-IR-NEXT:    v_add_i32_e32 v8, vcc, 0xffffffcf, v6
; GCN-IR-NEXT:    v_lshr_b64 v[4:5], v[0:1], v4
...
; GCN-IR-NEXT:    s_and_b64 s[8:9], s[8:9], exec
; GCN-IR-NEXT:  .LBB10_5: ; %udiv-do-while
; GCN-IR-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[4:5], 1
; GCN-IR-NEXT:    v_lshrrev_b32_e32 v0, 31, v3
; GCN-IR-NEXT:    v_or_b32_e32 v4, v4, v0
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[2:3], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, s10, v4
...
; GCN-IR-NEXT:    s_mov_b64 exec, s[8:9]
; GCN-IR-NEXT:    ; divergent control-flow edge
; GCN-IR-NEXT:    s_cbranch_execnz .LBB10_5
; GCN-IR-NEXT:  .LBB10_6: ; %udiv-loop-exit
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[2:3], 1
; GCN-IR-NEXT:    v_or_b32_e32 v1, v1, v3
; GCN-IR-NEXT:    v_or_b32_e32 v0, v0, v2
; GCN-IR-NEXT:  .LBB10_7: ; %udiv-end
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    s_setpc_b64 s[30:31]
; GCN-IR-NEXT:  .LBB10_8:
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, v1, 0, s[10:11]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v0, v0, 0, s[10:11]
; GCN-IR-NEXT:    s_branch .LBB10_1
; GCN-IR-NEXT:  .LBB10_9:
; GCN-IR-NEXT:    v_mov_b32_e32 v0, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v1, 0
; GCN-IR-NEXT:    s_branch .LBB10_3
...
; GCN-IR-NEXT:    v_or_b32_e32 v4, v4, v0
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[2:3], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, 23, v4
; GCN-IR-NEXT:    v_subb_u32_e32 v0, vcc, 0, v5, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v2, v6, v2
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v6, 31, v0
; GCN-IR-NEXT:    v_and_b32_e32 v0, 1, v6
