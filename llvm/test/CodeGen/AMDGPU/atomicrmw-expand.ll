...
; GFX1100-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v4
; GFX1100-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
; GFX1100-NEXT:    s_or_b32 s0, s0, s1
; GFX1100-NEXT:    s_mov_b32 exec_lo, vcc_lo
...
; GFX90A-NEXT:    s_xor_b64 s[8:9], s[8:9], s[10:11]
; GFX90A-NEXT:    s_and_b64 vcc, exec, s[8:9]
...
; GFX942-NEXT:    s_mov_b64 s[6:7], -1
; GFX942-NEXT:    s_xor_b64 s[4:5], s[4:5], s[6:7]
