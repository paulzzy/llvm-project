...
; GFX7LESS-NEXT:    s_mul_i32 s0, s0, 5
...
; GFX1064-NEXT:    s_mul_i32 s0, s0, 5
...
; GFX1032-NEXT:    s_mul_i32 s0, s0, 5
...
; GFX1164-NEXT:    s_mul_i32 s0, s0, 5
...
; GFX1132-NEXT:    s_mul_i32 s0, s0, 5
...
; GFX7LESS-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_mul_i32 s0, s2, s0
; GFX7LESS-NEXT:    v_mov_b32_e32 v1, 0
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s0
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_add_rtn_u32 v1, v1, v2
...
; GFX7LESS-NEXT:    s_or_b64 exec, exec, vcc
; GFX7LESS-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x9
...
; GFX1032-NEXT:    v_mov_b32_e32 v1, 0
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-NEXT:    s_mul_i32 s1, s0, s1
...
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s3, s2
; GFX7LESS_ITERATIVE-NEXT:    s_ff1_i32_b64 s8, s[0:1]
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s2, v0, s8
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX7LESS_ITERATIVE-NEXT:    s_add_i32 s2, s3, s2
...
; GFX7LESS_ITERATIVE-NEXT:    v_writelane_b32 v1, s3, m0
...
; GFX7LESS_ITERATIVE-NEXT:    s_xor_b64 s[0:1], exec, vcc
...
; GFX8_ITERATIVE-NEXT:    s_xor_b64 s[0:1], exec, vcc
...
; GFX9_ITERATIVE-NEXT:    s_xor_b64 s[0:1], exec, vcc
...
; GFX1064_ITERATIVE-NEXT:    s_xor_b64 s[0:1], exec, vcc
...
; GFX1032_ITERATIVE-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
...
; GFX1164_ITERATIVE-NEXT:    s_xor_b64 s[0:1], exec, vcc
...
; GFX1132_ITERATIVE-NEXT:    s_xor_b32 s1, exec_lo, vcc_lo
...
; GFX1064_DPP-NEXT:    v_readlane_b32 s1, v1, 47
; GFX1064_DPP-NEXT:    v_writelane_b32 v3, s6, 32
; GFX1064_DPP-NEXT:    s_mov_b64 exec, s[2:3]
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX1064_DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GFX1064_DPP-NEXT:    s_or_saveexec_b64 s[2:3], -1
; GFX1064_DPP-NEXT:    v_writelane_b32 v3, s1, 48
; GFX1064_DPP-NEXT:    s_mov_b64 exec, s[2:3]
...
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v4, s0
...
; GFX1164_DPP-NEXT:    v_readlane_b32 s1, v1, 47
; GFX1164_DPP-NEXT:    v_writelane_b32 v3, s6, 32
; GFX1164_DPP-NEXT:    s_mov_b64 exec, s[2:3]
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX1164_DPP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GFX1164_DPP-NEXT:    s_or_saveexec_b64 s[2:3], -1
; GFX1164_DPP-NEXT:    v_writelane_b32 v3, s1, 48
; GFX1164_DPP-NEXT:    s_mov_b64 exec, s[2:3]
...
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v4, s0
...
; GFX1132_DPP-NEXT:    s_or_saveexec_b32 s0, -1
; GFX1132_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_3)
...
; GFX7LESS-NEXT:    s_mov_b64 s[0:1], exec
; GFX7LESS-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s0, 0
; GFX7LESS-NEXT:    v_mbcnt_hi_u32_b32_e32 v2, s1, v0
...
; GFX8-NEXT:    s_mov_b64 s[0:1], exec
; GFX8-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX8-NEXT:    v_mbcnt_hi_u32_b32 v2, s1, v0
...
; GFX9-NEXT:    s_mov_b64 s[0:1], exec
; GFX9-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX9-NEXT:    v_mbcnt_hi_u32_b32 v2, s1, v0
...
; GFX1064-NEXT:    s_mov_b64 s[0:1], exec
; GFX1064-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX1064-NEXT:    v_mbcnt_hi_u32_b32 v2, s1, v0
...
; GFX1032-NEXT:    v_mbcnt_lo_u32_b32 v2, s0, 0
...
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX1164-NEXT:    v_mbcnt_hi_u32_b32 v2, s1, v0
...
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132-NEXT:    v_mbcnt_lo_u32_b32 v2, s0, 0
...
; GFX1132-NEXT:    s_mul_i32 s0, s0, 5
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX7LESS-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x9
...
; GFX7LESS-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX7LESS-NEXT:    s_xor_b64 s[8:9], s[0:1], exec
...
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_mul_i32 s3, s7, s2
...
; GFX7LESS-NEXT:    s_mov_b32 s0, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s1, -1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s2, v1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s3, v0
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    v_mul_lo_u32 v0, s7, v2
; GFX7LESS-NEXT:    v_mul_hi_u32 v1, s6, v2
; GFX7LESS-NEXT:    v_mul_lo_u32 v2, s6, v2
; GFX7LESS-NEXT:    s_mov_b32 s6, s1
; GFX7LESS-NEXT:    s_mov_b32 s7, s0
...
; GFX8-NEXT:    s_mov_b32 s2, 0xf000
; GFX8-NEXT:    s_mov_b32 s3, -1
; GFX8-NEXT:    s_mov_b32 s6, s3
; GFX8-NEXT:    s_mov_b32 s7, s2
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mul_i32 s5, s3, s4
; GFX9-NEXT:    s_mul_hi_u32 s6, s2, s4
...
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    s_mul_i32 s5, s3, s4
; GFX1064-NEXT:    s_mul_hi_u32 s6, s2, s4
; GFX1064-NEXT:    s_mul_i32 s4, s2, s4
; GFX1064-NEXT:    s_add_i32 s6, s6, s5
...
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-NEXT:    s_mul_i32 s5, s3, s4
; GFX1032-NEXT:    s_mul_hi_u32 s6, s2, s4
; GFX1032-NEXT:    s_mul_i32 s4, s2, s4
; GFX1032-NEXT:    s_add_i32 s6, s6, s5
...
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    s_mul_i32 s5, s3, s4
; GFX1164-NEXT:    s_mul_hi_u32 s6, s2, s4
; GFX1164-NEXT:    s_mul_i32 s4, s2, s4
; GFX1164-NEXT:    s_add_i32 s6, s6, s5
...
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    s_mul_i32 s5, s3, s4
; GFX1132-NEXT:    s_mul_hi_u32 s6, s2, s4
; GFX1132-NEXT:    s_mul_i32 s4, s2, s4
; GFX1132-NEXT:    s_add_i32 s6, s6, s5
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, s6
...
; GFX7LESS_ITERATIVE-NEXT:    s_add_u32 s8, s0, s8
...
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s0, s8
...
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s2, v0, s8
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX7LESS_ITERATIVE-NEXT:    s_and_b32 s2, s3, s2
; GFX7LESS_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 m0, s8
...
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s10, s0
...
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[2:3], 0
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    v_writelane_b32 v1, s10, m0
...
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s2, v0, s8
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX7LESS_ITERATIVE-NEXT:    s_or_b32 s2, s3, s2
; GFX7LESS_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 m0, s8
...
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s2, v0, s8
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX7LESS_ITERATIVE-NEXT:    s_xor_b32 s2, s3, s2
; GFX7LESS_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 m0, s8
...
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s2, v0, s8
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX7LESS_ITERATIVE-NEXT:    s_max_i32 s2, s3, s2
; GFX7LESS_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 m0, s8
...
; GFX8_DPP-NEXT:    v_cndmask_b32_e64 v2, v1, v0, s[2:3]
; GFX8_DPP-NEXT:    s_nop 1
...
; GFX9_DPP-NEXT:    v_cndmask_b32_e64 v2, v1, v0, s[2:3]
; GFX9_DPP-NEXT:    s_nop 1
...
; GFX7LESS_ITERATIVE-NEXT:    s_cselect_b32 s7, s3, s9
; GFX7LESS_ITERATIVE-NEXT:    s_cselect_b32 s6, s2, s10
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[8:9], 1, s8
; GFX7LESS_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[8:9]
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[8:9], s[0:1], 0
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[8:9]
; GFX7LESS_ITERATIVE-NEXT:    v_writelane_b32 v1, s2, m0
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b64 s[2:3], s[6:7]
...
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s2, v0, s8
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX7LESS_ITERATIVE-NEXT:    s_min_i32 s2, s3, s2
; GFX7LESS_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 m0, s8
...
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s2, v0, s8
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX7LESS_ITERATIVE-NEXT:    s_max_u32 s2, s3, s2
; GFX7LESS_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 m0, s8
...
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s2, v0, s8
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[6:7], 1, s8
; GFX7LESS_ITERATIVE-NEXT:    s_min_u32 s2, s3, s2
; GFX7LESS_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 m0, s8
