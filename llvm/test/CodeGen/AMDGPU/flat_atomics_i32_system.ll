...
; GCN1-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GCN1-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v4
; GCN1-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GCN1-NEXT:    v_mov_b32_e32 v4, v3
; GCN1-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GCN1-NEXT:    s_mov_b64 exec, vcc
...
; GCN2-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GCN2-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v4
; GCN2-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GCN2-NEXT:    v_mov_b32_e32 v4, v3
; GCN2-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GCN2-NEXT:    s_mov_b64 exec, vcc
...
; GCN3-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GCN3-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v4
; GCN3-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GCN3-NEXT:    v_mov_b32_e32 v4, v3
; GCN3-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GCN3-NEXT:    s_mov_b64 exec, vcc
...
; GCN1-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GCN1-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v1
; GCN1-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GCN1-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GCN1-NEXT:    s_mov_b64 exec, vcc
; GCN1-NEXT:    ; divergent control-flow edge
...
; GCN2-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GCN2-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v1
; GCN2-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GCN2-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GCN2-NEXT:    s_mov_b64 exec, vcc
; GCN2-NEXT:    ; divergent control-flow edge
...
; GCN1-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN1-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GCN1-NEXT:    s_xor_b64 s[36:37], exec, vcc
...
; GCN2-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN2-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GCN2-NEXT:    s_xor_b64 s[36:37], exec, vcc
...
; GCN3-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN3-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GCN3-NEXT:    s_xor_b64 s[36:37], exec, vcc
...
; GCN1-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN1-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GCN1-NEXT:    s_xor_b64 s[4:5], exec, vcc
; GCN1-NEXT:    v_mov_b32_e32 v3, v2
...
; GCN2-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN2-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GCN2-NEXT:    s_xor_b64 s[4:5], exec, vcc
; GCN2-NEXT:    v_mov_b32_e32 v3, v2
...
; GCN3-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN3-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GCN3-NEXT:    s_xor_b64 s[4:5], exec, vcc
; GCN3-NEXT:    v_mov_b32_e32 v3, v2
...
; GCN1-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN1-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GCN1-NEXT:    s_xor_b64 s[34:35], exec, vcc
; GCN1-NEXT:    v_mov_b32_e32 v3, v2
...
; GCN2-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN2-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GCN2-NEXT:    s_xor_b64 s[34:35], exec, vcc
; GCN2-NEXT:    v_mov_b32_e32 v3, v2
...
; GCN3-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN3-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v3
; GCN3-NEXT:    s_xor_b64 s[34:35], exec, vcc
; GCN3-NEXT:    v_mov_b32_e32 v3, v2
