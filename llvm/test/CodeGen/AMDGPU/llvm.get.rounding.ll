...
; RUN: llc -mtriple=amdgcn -mcpu=tahiti -amdgpu-late-wave-transform=1 < %s | FileCheck -check-prefixes=GCN,GFX678,GFX6 %s
; RUN: llc -mtriple=amdgcn -mcpu=hawaii -amdgpu-late-wave-transform=1 < %s | FileCheck -check-prefixes=GCN,GFX678,GFX7 %s
; RUN: llc -mtriple=amdgcn -mcpu=fiji -amdgpu-late-wave-transform=1 < %s | FileCheck -check-prefixes=GCN,GFX678,GFX8 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx900 -amdgpu-late-wave-transform=1 < %s | FileCheck -check-prefixes=GCN,GFX9 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1030 -amdgpu-late-wave-transform=1 < %s | FileCheck -check-prefixes=GCN,GFX1011,GFX10 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 -amdgpu-late-wave-transform=1 < %s | FileCheck -check-prefixes=GCN,GFX1011,GFX11 %s
