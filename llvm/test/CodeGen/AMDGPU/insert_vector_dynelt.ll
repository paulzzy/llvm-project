...
; GCN-O0-NEXT:    buffer_store_dword v64, off, s[8:11], 0 offset:392 ; 4-byte Folded Spill
...
; GCN-O0-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GCN-O0-NEXT:    buffer_load_dword v64, off, s[8:11], 0 offset:392 ; 4-byte Folded Reload
; GCN-O0-NEXT:    s_mov_b64 exec, s[4:5]
; GCN-O0-NEXT:    s_waitcnt vmcnt(0)
