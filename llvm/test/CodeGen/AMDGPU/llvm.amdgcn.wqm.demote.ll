...
; SI-NEXT:    s_xor_b64 s[16:17], vcc, exec
; SI-NEXT:    s_xor_b64 s[14:15], exec, s[16:17]
; SI-NEXT:    s_mov_b64 exec, s[16:17]
; SI-NEXT:    ; divergent control-flow edge
...
; GFX10-32-NEXT:    s_xor_b32 s14, vcc_lo, exec_lo
; GFX10-32-NEXT:    s_xor_b32 s13, exec_lo, s14
; GFX10-32-NEXT:    s_mov_b32 exec_lo, s14
; GFX10-32-NEXT:    ; divergent control-flow edge
...
; GFX10-64-NEXT:    s_xor_b64 s[16:17], vcc, exec
; GFX10-64-NEXT:    s_xor_b64 s[14:15], exec, s[16:17]
; GFX10-64-NEXT:    s_mov_b64 exec, s[16:17]
; GFX10-64-NEXT:    ; divergent control-flow edge
...
; GFX10-32-NEXT:    s_xor_b32 s1, exec_lo, s2
; GFX10-32-NEXT:    s_and_b32 s1, s1, exec_lo
; GFX10-32-NEXT:    s_mov_b32 exec_lo, s2
; GFX10-32-NEXT:    ; divergent control-flow edge
...
; SI-NEXT:    s_xor_b64 s[6:7], exec, s[10:11]
...
; GFX10-32-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX10-32-NEXT:    s_xor_b32 s5, vcc_lo, exec_lo
...
; GFX10-64-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX10-64-NEXT:    s_xor_b64 s[10:11], vcc, exec
