...
; SI-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v4
...
; VI-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v6
...
; SI-NEXT:    s_xor_b64 s[38:39], exec, vcc
...
; VI-NEXT:    s_xor_b64 s[36:37], exec, vcc
...
; VI-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v5
; VI-NEXT:    s_xor_b64 s[36:37], exec, vcc
; VI-NEXT:    s_or_b64 s[34:35], s[34:35], s[36:37]
; VI-NEXT:    s_mov_b64 exec, vcc
; VI-NEXT:    ; divergent control-flow edge
...
; VI-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v4
; VI-NEXT:    s_xor_b64 s[36:37], exec, vcc
; VI-NEXT:    s_or_b64 s[34:35], s[34:35], s[36:37]
; VI-NEXT:    s_mov_b64 exec, vcc
; VI-NEXT:    ; divergent control-flow edge
...
; SI-NEXT:    v_mov_b32_e32 v2, v6
; SI-NEXT:    v_mov_b32_e32 v3, v7
; SI-NEXT:    s_xor_b64 s[8:9], exec, vcc
...
; SI-NEXT:    v_mov_b32_e32 v2, v4
; SI-NEXT:    v_mov_b32_e32 v3, v5
; SI-NEXT:    s_xor_b64 s[6:7], exec, vcc
...
; SI-NEXT:    v_mov_b32_e32 v2, v6
; SI-NEXT:    v_mov_b32_e32 v3, v7
; SI-NEXT:    s_xor_b64 s[36:37], exec, vcc
...
; VI-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v2
; VI-NEXT:    v_mov_b32_e32 v3, v1
; VI-NEXT:    s_xor_b64 s[34:35], exec, vcc
; VI-NEXT:    v_mov_b32_e32 v2, v0
; VI-NEXT:    s_or_b64 s[38:39], s[38:39], s[34:35]
; VI-NEXT:    s_mov_b64 exec, vcc
; VI-NEXT:    ; divergent control-flow edge
