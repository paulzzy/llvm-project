...
;RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=verde | FileCheck %s --check-prefixes=CHECK,SI
;RUN: llc < %s -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=tonga | FileCheck %s --check-prefixes=CHECK,VI
