...
;
;
; ASM-SDAG-TRUE16-LABEL: dead_i32:
...
; ASM-SDAG-TRUE16-NEXT:    v_mov_b32_e32 v4, v0
; ASM-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v0, v1 :: v_dual_and_b32 v1, 1, v4
...
; ASM-SDAG-TRUE16-NEXT:    s_cbranch_execz .LBB0_2
; ASM-SDAG-TRUE16-NEXT:  .LBB0_1: ; %if.then
; ASM-SDAG-TRUE16-NEXT:    v_add_nc_u32_e32 v0, 1, v0
; ASM-SDAG-TRUE16-NEXT:    global_store_b32 v[2:3], v0, off
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr0
; ASM-SDAG-TRUE16-NEXT:  .LBB0_2: ; %if.end
; ASM-SDAG-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-SDAG-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; ASM-SDAG-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; ASM-SDAG-FAKE16-LABEL: dead_i32:
...
; ASM-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v4, v0
; ASM-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v0, v1 :: v_dual_and_b32 v1, 1, v4
...
; ASM-SDAG-FAKE16-NEXT:    s_cbranch_execz .LBB0_2
; ASM-SDAG-FAKE16-NEXT:  .LBB0_1: ; %if.then
; ASM-SDAG-FAKE16-NEXT:    v_add_nc_u32_e32 v0, 1, v0
; ASM-SDAG-FAKE16-NEXT:    global_store_b32 v[2:3], v0, off
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr0
; ASM-SDAG-FAKE16-NEXT:  .LBB0_2: ; %if.end
; ASM-SDAG-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
;
;
; ASM-SDAG-TRUE16-LABEL: dead_struct:
; ASM-SDAG-TRUE16:       ; %bb.0: ; %entry
; ASM-SDAG-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; ASM-SDAG-TRUE16-NEXT:    s_wait_expcnt 0x0
; ASM-SDAG-TRUE16-NEXT:    s_wait_samplecnt 0x0
; ASM-SDAG-TRUE16-NEXT:    s_wait_bvhcnt 0x0
; ASM-SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
; ASM-SDAG-TRUE16-NEXT:    v_mov_b32_e32 v20, v0
; ASM-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v0, v1 :: v_dual_and_b32 v1, 1, v20
; ASM-SDAG-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v1
; ASM-SDAG-TRUE16-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; ASM-SDAG-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-SDAG-TRUE16-NEXT:    s_xor_b32 s0, exec_lo, s1
; ASM-SDAG-TRUE16-NEXT:    s_mov_b32 exec_lo, s1
; ASM-SDAG-TRUE16-NEXT:    ; divergent control-flow edge
; ASM-SDAG-TRUE16-NEXT:    s_cbranch_execz .LBB1_2
; ASM-SDAG-TRUE16-NEXT:  .LBB1_1: ; %if.then
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v11, 0 :: v_dual_add_nc_u32 v0, 15, v19
; ASM-SDAG-TRUE16-NEXT:    v_mov_b32_e32 v2, 0x3fc00000
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr3_vgpr4_vgpr5
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr6_vgpr7
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr8
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr9_vgpr10
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr15
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr16
; ASM-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v12, v11 :: v_dual_mov_b32 v13, v11
; ASM-SDAG-TRUE16-NEXT:    v_mov_b32_e32 v14, v11
; ASM-SDAG-TRUE16-NEXT:    global_store_b32 v[17:18], v0, off
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr0
; ASM-SDAG-TRUE16-NEXT:  .LBB1_2: ; %if.end
; ASM-SDAG-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-SDAG-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v1, v2 :: v_dual_mov_b32 v2, v3
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v3, v4 :: v_dual_mov_b32 v4, v5
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v5, v6 :: v_dual_mov_b32 v6, v7
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v7, v8 :: v_dual_mov_b32 v8, v9
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v9, v10 :: v_dual_mov_b32 v10, v11
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v11, v12 :: v_dual_mov_b32 v12, v13
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v13, v14 :: v_dual_mov_b32 v14, v15
; ASM-SDAG-TRUE16-NEXT:    v_mov_b32_e32 v15, v16
; ASM-SDAG-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; ASM-SDAG-FAKE16-LABEL: dead_struct:
; ASM-SDAG-FAKE16:       ; %bb.0: ; %entry
; ASM-SDAG-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; ASM-SDAG-FAKE16-NEXT:    s_wait_expcnt 0x0
; ASM-SDAG-FAKE16-NEXT:    s_wait_samplecnt 0x0
; ASM-SDAG-FAKE16-NEXT:    s_wait_bvhcnt 0x0
; ASM-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; ASM-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v20, v0
; ASM-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v0, v1 :: v_dual_and_b32 v1, 1, v20
; ASM-SDAG-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v1
; ASM-SDAG-FAKE16-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; ASM-SDAG-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-SDAG-FAKE16-NEXT:    s_xor_b32 s0, exec_lo, s1
; ASM-SDAG-FAKE16-NEXT:    s_mov_b32 exec_lo, s1
; ASM-SDAG-FAKE16-NEXT:    ; divergent control-flow edge
; ASM-SDAG-FAKE16-NEXT:    s_cbranch_execz .LBB1_2
; ASM-SDAG-FAKE16-NEXT:  .LBB1_1: ; %if.then
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v11, 0 :: v_dual_add_nc_u32 v0, 15, v19
; ASM-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v2, 0x3fc00000
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr3_vgpr4_vgpr5
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr6_vgpr7
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr8
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr9_vgpr10
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr15
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr16
; ASM-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v12, v11 :: v_dual_mov_b32 v13, v11
; ASM-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v14, v11
; ASM-SDAG-FAKE16-NEXT:    global_store_b32 v[17:18], v0, off
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr0
; ASM-SDAG-FAKE16-NEXT:  .LBB1_2: ; %if.end
; ASM-SDAG-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-SDAG-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v1, v2 :: v_dual_mov_b32 v2, v3
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v3, v4 :: v_dual_mov_b32 v4, v5
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v5, v6 :: v_dual_mov_b32 v6, v7
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v7, v8 :: v_dual_mov_b32 v8, v9
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v9, v10 :: v_dual_mov_b32 v10, v11
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v11, v12 :: v_dual_mov_b32 v12, v13
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v13, v14 :: v_dual_mov_b32 v14, v15
; ASM-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v15, v16
; ASM-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
;
;
; ASM-SDAG-TRUE16-LABEL: dead_array:
; ASM-SDAG-TRUE16:       ; %bb.0: ; %entry
; ASM-SDAG-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; ASM-SDAG-TRUE16-NEXT:    s_wait_expcnt 0x0
; ASM-SDAG-TRUE16-NEXT:    s_wait_samplecnt 0x0
; ASM-SDAG-TRUE16-NEXT:    s_wait_bvhcnt 0x0
; ASM-SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v32, v30 :: v_dual_mov_b32 v33, v0
; ASM-SDAG-TRUE16-NEXT:    v_mov_b32_e32 v0, v1
; ASM-SDAG-TRUE16-NEXT:    s_clause 0x4
; ASM-SDAG-TRUE16-NEXT:    scratch_load_b32 v35, off, s32 offset:12
; ASM-SDAG-TRUE16-NEXT:    scratch_load_b32 v34, off, s32 offset:8
; ASM-SDAG-TRUE16-NEXT:    scratch_load_b32 v31, off, s32 offset:4
; ASM-SDAG-TRUE16-NEXT:    scratch_load_b32 v30, off, s32
; ASM-SDAG-TRUE16-NEXT:    scratch_load_b32 v1, off, s32 offset:16
; ASM-SDAG-TRUE16-NEXT:    v_and_b32_e32 v33, 1, v33
; ASM-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; ASM-SDAG-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v33
; ASM-SDAG-TRUE16-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; ASM-SDAG-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-SDAG-TRUE16-NEXT:    s_xor_b32 s0, exec_lo, s1
; ASM-SDAG-TRUE16-NEXT:    s_mov_b32 exec_lo, s1
; ASM-SDAG-TRUE16-NEXT:    ; divergent control-flow edge
; ASM-SDAG-TRUE16-NEXT:    s_cbranch_execz .LBB2_2
; ASM-SDAG-TRUE16-NEXT:  .LBB2_1: ; %if.then
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v8, 15 :: v_dual_mov_b32 v7, 13
; ASM-SDAG-TRUE16-NEXT:    s_wait_loadcnt 0x0
; ASM-SDAG-TRUE16-NEXT:    v_add_nc_u32_e32 v0, 15, v1
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr2
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr3
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr4
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr5
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr6
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr9
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr10
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr11
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr12
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr13
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr14
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr15
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr16
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr17
...
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr32
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr30
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr31
; ASM-SDAG-TRUE16-NEXT:    global_store_b32 v[34:35], v0, off
; ASM-SDAG-TRUE16-NEXT:    ; implicit-def: $vgpr0
; ASM-SDAG-TRUE16-NEXT:  .LBB2_2: ; %if.end
; ASM-SDAG-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-SDAG-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; ASM-SDAG-TRUE16-NEXT:    s_wait_loadcnt 0x0
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v1, v2 :: v_dual_mov_b32 v2, v3
...
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v11, v12 :: v_dual_mov_b32 v12, v13
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v13, v14 :: v_dual_mov_b32 v14, v15
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v15, v16 :: v_dual_mov_b32 v16, v17
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v17, v18 :: v_dual_mov_b32 v18, v19
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v19, v20 :: v_dual_mov_b32 v20, v21
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v21, v22 :: v_dual_mov_b32 v22, v23
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v23, v24 :: v_dual_mov_b32 v24, v25
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v25, v26 :: v_dual_mov_b32 v26, v27
; ASM-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v27, v28 :: v_dual_mov_b32 v28, v29
; ASM-SDAG-TRUE16-NEXT:    v_mov_b32_e32 v29, v32
; ASM-SDAG-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; ASM-SDAG-FAKE16-LABEL: dead_array:
; ASM-SDAG-FAKE16:       ; %bb.0: ; %entry
; ASM-SDAG-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; ASM-SDAG-FAKE16-NEXT:    s_wait_expcnt 0x0
; ASM-SDAG-FAKE16-NEXT:    s_wait_samplecnt 0x0
; ASM-SDAG-FAKE16-NEXT:    s_wait_bvhcnt 0x0
; ASM-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v32, v30 :: v_dual_mov_b32 v33, v0
; ASM-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v0, v1
; ASM-SDAG-FAKE16-NEXT:    s_clause 0x4
; ASM-SDAG-FAKE16-NEXT:    scratch_load_b32 v35, off, s32 offset:12
; ASM-SDAG-FAKE16-NEXT:    scratch_load_b32 v34, off, s32 offset:8
; ASM-SDAG-FAKE16-NEXT:    scratch_load_b32 v31, off, s32 offset:4
; ASM-SDAG-FAKE16-NEXT:    scratch_load_b32 v30, off, s32
; ASM-SDAG-FAKE16-NEXT:    scratch_load_b32 v1, off, s32 offset:16
; ASM-SDAG-FAKE16-NEXT:    v_and_b32_e32 v33, 1, v33
; ASM-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; ASM-SDAG-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v33
; ASM-SDAG-FAKE16-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; ASM-SDAG-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-SDAG-FAKE16-NEXT:    s_xor_b32 s0, exec_lo, s1
; ASM-SDAG-FAKE16-NEXT:    s_mov_b32 exec_lo, s1
; ASM-SDAG-FAKE16-NEXT:    ; divergent control-flow edge
; ASM-SDAG-FAKE16-NEXT:    s_cbranch_execz .LBB2_2
; ASM-SDAG-FAKE16-NEXT:  .LBB2_1: ; %if.then
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v8, 15 :: v_dual_mov_b32 v7, 13
; ASM-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; ASM-SDAG-FAKE16-NEXT:    v_add_nc_u32_e32 v0, 15, v1
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr2
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr3
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr4
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr5
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr6
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr9
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr10
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr11
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr12
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr13
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr14
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr15
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr16
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr17
...
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr32
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr30
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr31
; ASM-SDAG-FAKE16-NEXT:    global_store_b32 v[34:35], v0, off
; ASM-SDAG-FAKE16-NEXT:    ; implicit-def: $vgpr0
; ASM-SDAG-FAKE16-NEXT:  .LBB2_2: ; %if.end
; ASM-SDAG-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; ASM-SDAG-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; ASM-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v1, v2 :: v_dual_mov_b32 v2, v3
...
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v11, v12 :: v_dual_mov_b32 v12, v13
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v13, v14 :: v_dual_mov_b32 v14, v15
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v15, v16 :: v_dual_mov_b32 v16, v17
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v17, v18 :: v_dual_mov_b32 v18, v19
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v19, v20 :: v_dual_mov_b32 v20, v21
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v21, v22 :: v_dual_mov_b32 v22, v23
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v23, v24 :: v_dual_mov_b32 v24, v25
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v25, v26 :: v_dual_mov_b32 v26, v27
; ASM-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v27, v28 :: v_dual_mov_b32 v28, v29
; ASM-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v29, v32
; ASM-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
