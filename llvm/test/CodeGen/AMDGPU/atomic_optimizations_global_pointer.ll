...
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_mul_i32 s5, s4, s5
; GFX7LESS-NEXT:    s_mov_b32 s8, s2
; GFX7LESS-NEXT:    s_mov_b32 s9, s3
...
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s7, s6
; GFX7LESS_ITERATIVE-NEXT:    s_ff1_i32_b64 s8, s[0:1]
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s6, v0, s8
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[2:3], 1, s8
; GFX7LESS_ITERATIVE-NEXT:    s_add_i32 s6, s7, s6
...
; GFX7LESS_ITERATIVE-NEXT:    v_writelane_b32 v1, s7, m0
...
; GFX7LESS_ITERATIVE-NEXT:    s_add_u32 s8, s6, s8
...
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7LESS-NEXT:    v_mul_lo_u32 v0, s12, v3
; GFX7LESS-NEXT:    v_sub_i32_e32 v0, vcc, s4, v0
; GFX7LESS-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX7LESS_ITERATIVE-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s6, s12
; GFX7LESS_ITERATIVE-NEXT:    s_ff1_i32_b64 s7, s[0:1]
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s12, v0, s7
; GFX7LESS_ITERATIVE-NEXT:    s_lshl_b64 s[2:3], 1, s7
; GFX7LESS_ITERATIVE-NEXT:    s_add_i32 s12, s6, s12
; GFX7LESS_ITERATIVE-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[2:3]
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_ne_u64_e64 s[2:3], s[0:1], 0
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 vcc, exec, s[2:3]
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 m0, s7
; GFX7LESS_ITERATIVE-NEXT:    v_writelane_b32 v3, s6, m0
...
; GFX7LESS-NEXT:    s_mul_i32 s15, s8, s6
; GFX7LESS-NEXT:    s_mov_b32 s7, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s6, -1
...
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s7, v1, s6
; GFX7LESS_ITERATIVE-NEXT:    v_readlane_b32 s10, v0, s6
...
; GFX7LESS_ITERATIVE-NEXT:    s_addc_u32 s11, s3, s7
...
; GFX7LESS-NEXT:    s_mov_b32 s10, s4
; GFX7LESS-NEXT:    s_lshl_b32 s13, s5, 3
; GFX7LESS-NEXT:    s_load_dword s4, s[10:11], 0x0
; GFX7LESS-NEXT:    s_and_b32 s5, s12, 0xff
; GFX7LESS-NEXT:    s_mov_b32 s7, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s6, -1
; GFX7LESS-NEXT:    s_lshl_b32 s14, s5, s13
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    v_mov_b32_e32 v1, s4
...
; GFX7LESS-NEXT:    s_bcnt1_i32_b64 s4, s[6:7]
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_and_b32 s5, s10, -4
; GFX7LESS-NEXT:    s_and_b32 s6, s10, 3
; GFX7LESS-NEXT:    s_mul_i32 s4, s12, s4
; GFX7LESS-NEXT:    s_mov_b32 s10, s5
; GFX7LESS-NEXT:    s_lshl_b32 s13, s6, 3
; GFX7LESS-NEXT:    s_load_dword s5, s[10:11], 0x0
; GFX7LESS-NEXT:    s_lshl_b32 s14, 0xff, s13
; GFX7LESS-NEXT:    s_and_b32 s4, s4, 0xff
; GFX7LESS-NEXT:    s_not_b32 s15, s14
; GFX7LESS-NEXT:    s_mov_b32 s7, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s6, -1
...
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    v_add_i32_e64 v0, s[0:1], s16, v1
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
; GFX7LESS-NEXT:    v_and_b32_e32 v2, s15, v1
; GFX7LESS-NEXT:    v_and_b32_e32 v0, s14, v0
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v1, v2
; GFX7LESS-NEXT:    s_xor_b64 s[12:13], exec, vcc
...
; GFX7LESS-NEXT:    s_lshl_b32 s13, s6, 3
; GFX7LESS-NEXT:    s_load_dword s5, s[10:11], 0x0
; GFX7LESS-NEXT:    s_lshl_b32 s14, 0xffff, s13
