...
; CHECK-NEXT:    v_cmp_ne_u32_e64 s4, 1, v3
; CHECK-NEXT:    s_branch .LBB0_2
; CHECK-NEXT:  .LBB0_1: ; %for.end121
; CHECK-NEXT:    ; in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    s_inst_prefetch 0x2
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s12
; CHECK-NEXT:    v_cmp_eq_u32_e64 s5, 0, v3
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; j lastloop entry
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    s_or_b32 s10, s10, s5
; CHECK-NEXT:    s_xor_b32 s5, exec_lo, s10
; CHECK-NEXT:    s_and_b32 s5, s5, exec_lo
; CHECK-NEXT:    s_or_b32 s8, s8, s5
...
; CHECK-NEXT:    s_and_b32 s5, exec_lo, vcc_lo
; CHECK-NEXT:    s_xor_b32 s5, vcc_lo, -1
; CHECK-NEXT:    v_mov_b32_e32 v3, 0
; CHECK-NEXT:    s_and_b32 s5, s5, exec_lo
; CHECK-NEXT:    v_mov_b32_e32 v1, 0
; CHECK-NEXT:    s_or_b32 s7, s7, s5
; CHECK-NEXT:    s_mov_b32 s10, 0
; CHECK-NEXT:    s_xor_b32 s5, exec_lo, s7
; CHECK-NEXT:    s_and_b32 s12, s5, exec_lo
...
; CHECK-NEXT:    s_add_i32 s13, s13, 4
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; backedge
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    v_cmp_lt_u32_e64 s5, v4, v0
; CHECK-NEXT:    s_xor_b32 s11, exec_lo, s5
; CHECK-NEXT:    s_and_b32 s11, s11, exec_lo
; CHECK-NEXT:    s_or_b32 s12, s12, s11
...
; CHECK-NEXT:    s_or_b32 s9, s9, s5
; CHECK-NEXT:    s_xor_b32 s5, exec_lo, s9
; CHECK-NEXT:    s_and_b32 s5, s5, exec_lo
; CHECK-NEXT:    s_or_b32 s11, s11, s5
