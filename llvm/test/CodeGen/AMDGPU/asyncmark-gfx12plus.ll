...
; RUN: llc -amdgpu-late-wave-transform=0 -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck %s -check-prefixes=GISEL
...
; SDAG-NEXT:    s_wait_loadcnt 0x0
; SDAG-NEXT:    v_dual_mov_b32 v4, v5 :: v_dual_mov_b32 v8, v3
; SDAG-NEXT:    v_dual_mov_b32 v9, s12 :: v_dual_add_nc_u32 v10, v6, v7
; SDAG-NEXT:    s_clause 0x1
; SDAG-NEXT:    global_load_b32 v3, v0, s[4:5]
; SDAG-NEXT:    global_load_b32 v5, v0, s[0:1]
; SDAG-NEXT:    v_dual_mov_b32 v7, v2 :: v_dual_mov_b32 v6, v1
...
; SDAG-NEXT:    s_mov_b64 s[12:13], s[6:7]
; SDAG-NEXT:    s_wait_xcnt 0x0
; SDAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 4
...
; SDAG-NEXT:    global_store_b32 v0, v9, s[12:13]
...
; SDAG-NEXT:    s_wait_xcnt 0x0
; SDAG-NEXT:    v_dual_add_nc_u32 v2, v8, v4 :: v_dual_mov_b32 v0, s1
