...
; RUN: llc -mtriple=amdgcn-amd-amdpal -mcpu=gfx900 -amdgpu-late-wave-transform=1 < %s | FileCheck --check-prefix=GFX9 %s
...
; RUN: llc -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -amdgpu-late-wave-transform=1 < %s | FileCheck --check-prefix=GFX11 %s
