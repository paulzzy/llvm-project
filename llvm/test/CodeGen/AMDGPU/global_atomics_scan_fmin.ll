...
; GFX1064-DPP-NEXT:    s_xor_b64 s[2:3], exec, s[0:1]
...
; GFX1032-DPP-NEXT:    s_xor_b32 s1, exec_lo, s0
...
; GFX7LESS-NEXT:    v_mul_f32_e64 v2, 1.0, s10
...
; GFX9-NEXT:    v_max_f32_e64 v1, s9, s9
...
; GFX1064-NEXT:    v_max_f32_e64 v2, s7, s7
...
; GFX1164-NEXT:    v_max_f32_e64 v2, s7, s7
...
; GFX7LESS-NEXT:    v_max_f64 v[4:5], s[8:9], s[8:9]
...
; GFX9-NEXT:    v_max_f64 v[4:5], s[8:9], s[8:9]
...
; GFX1064-NEXT:    v_max_f64 v[4:5], s[6:7], s[6:7]
...
; GFX1032-NEXT:    s_lshl_b32 s3, 1, s3
; GFX1032-NEXT:    s_andn2_b32 s2, s2, s3
; GFX1032-NEXT:    v_max_f64 v[4:5], s[4:5], s[4:5]
...
; GFX1164-NEXT:    v_max_f64 v[4:5], s[8:9], s[8:9]
