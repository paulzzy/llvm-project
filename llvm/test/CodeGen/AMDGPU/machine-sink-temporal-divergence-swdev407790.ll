...
; CHECK-NEXT:    s_xor_b32 s99, exec_lo, s6
...
; CHECK-NEXT:    s_and_b32 s7, s65, exec_lo
...
; CHECK-NEXT:    v_add_nc_u32_e32 v59, s83, v46
; CHECK-NEXT:    s_mov_b32 s83, s4
