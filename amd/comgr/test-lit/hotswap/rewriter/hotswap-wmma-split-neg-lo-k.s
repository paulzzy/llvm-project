...
//
// neg_lo:[0,0,0] is the default encoded form, so the second half disassembles
// with no neg_lo suffix.
...
// COM: all-zero modifier vector is omitted by the disassembler). The trailing
// COM: `//` comment is what immediately follows
